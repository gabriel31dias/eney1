...
Route::get('/sitex', 'HomeController@site')->name('sitex');
...
Route::post('/entregadores/update', 'EntregadoresController@update')->name('updateentregadores');
...
Route::post('/configupdatepaymentpadrao','ConfigController@setPaymentDefault')->name("configPaymentDefault");
...
Route::post('/saveopt','OpcoesController@saveopt')->name("saveopt");
