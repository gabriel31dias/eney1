...
class SwitchForma extends Controller
{
   ...
   public static function requestVenda($codevenda){
       ...
       $url =  "https://ws.pagseguro.uol.com.br/v2/transactions/notifications/".$codevenda.$getemail_token;
       $curl = curl_init($url);
   ...
   public static function getemailtoken($codevenda){
        ...
        $email =  $getcalback_pg->emailpagseguro;
        $token = $getcalback_pg->pagsegurocode; 
