...
class VendaController extends Controller
{
    ...
    public function listvendas()
    {
        ...
        $filtrad_vendas = array_map(function ($value)
        {
            ...
            $value['valor_total'] = "<a  class='waves-effect waves-light btn btn-large  bg-light-blue' onclick='precos(" . number_format($value['preco_total_produto'], 2) . "," . number_format($value['preco_total_entrega'], 2) . "," . number_format($value['preco_total_adicionais'], 2) . ")'> <i class='material-icons'>attach_money</i>" . $value['valor_total'] . " Ver mais..</a>";
