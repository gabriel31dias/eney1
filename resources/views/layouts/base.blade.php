      ...
      <nav class="navbar bg-light-blue">
         <div class="container-fluid">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="{{route("home")}}">Versátile</a>
            </div>
            <div class="collapse navbar-collapse" id="navbar-collapse">
               <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown">
                     ...
                     <span class="label-count"><span id="ppp">0</span></span>
                     </a>
                  ...
                  <!-- #END# Tasks -->
                  <li  class="pull-right"><a href="javascript:void(0);" ><i class="material-icons">remove_circle</i></a></li>
...
async function getcodloja(){
 ...
 $("#eye").click(function(){
   ...
   location.href = "{{route('get_loja')}}/"+{{$codeloja}}
...
Swal.fire({
  ...
  <p class="swal2-title" id="swal2-title">Valor compra: ${venda.valortotalprodutos}</p>
  <p class="swal2-title" id="swal2-title">Telefone: ${venda.telefone}</p>
  <p class="swal2-title" id="swal2-title">Forma pagamento: ${venda.forma}</p>
  <p class="swal2-title" id="swal2-title">Troco: ${venda.troco}</p>
  <p class="swal2-title" id="swal2-title">Tipo retirada:  ${venda.tiporetirada}</p>
  `,
