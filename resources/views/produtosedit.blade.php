...
<form action="/" id="foto" id="f1" class="dropzone dz-clickable" method="post" enctype="multipart/form-data">
                            <div class="dz-message">
                                <div class="align-center drag-icon-cph">
                                   ...
                                   <center>
                                    <img src="{{$produto->IMG}}" id="myimage" height="200">
                             ...
                             <div class="form-group form-float">
                                    <div class="form-line">
                                      <label class="">Nome do produto</label>
                                        <input  value="{{$produto->NOME_PRODUTO}}" id="NOME_PRODUTO" name="NOME_PRODUTO" type="text" class="form-control">
                             ...
                             <div class="form-group form-float">
                                    <div class="form-line">
                                      <label  class="">Valor unitário</label>
                                        <input value="{{$produto->PRECO_UNIT}}"  id="PRECO_UNIT"  name="PRECO_UNIT" onfocus="masc(this)"  type="text" class="form-control">
                             ...
                             <div class="form-group form-float">
                                    <div class="form-line">
                                      <label  class="">Descrição produto</label>
                                        <textarea  value="{{$produto->DESCR}}"  id="DESCR" name="DESCR"  type="text" class="form-control"></textarea>
                             ...
                             <div class="form-group form-float">
                                    <div class="form-line">
                                      <label  class="">Valor custo</label>
                                        <input  value="{{$produto->PRECO_CUSTO}}"  id="PRECO_CUSTO" name="PRECO_CUSTO"  onfocus="masc(this)"  type="text" class="form-control">
                             ...
                             <div class="form-group form-float">
                                    <div class="form-line">
                                      <label  class="">CFOP</label>
                                        <input   value="{{$produto->CFOP}}" id="CFOP"  name="CFOP" type="text" class="form-control">
                             ...
                             <div class="form-group form-float">
                                    <div class="form-line">
                                      <label  class="">ICMS</label>
                                        <input  value="{{$produto->ICMS}}"   id="ICMS" name="ICMS"    type="text" class="form-control">
...
async function cad_opções(params) {
